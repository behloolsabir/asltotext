...
# model = trainData()
model = keras.models.load_model('/home/behlool/Documents/sign_to_text/asltotext/model_weights/keras.model')
...
def identifyGesture(handTrainImage):
    ...
    key = [key for key, value in classes.items() if value == predictions[0]][0]
    return key
